				...
				<div class="llms-access-plan-footer">
					...
					<?php if ( $plan->has_availability_restrictions() ) : ?>
						<?php foreach ( $plan->get_array( 'availability_restrictions' ) as $mid ) : ?>
							<a class="btn cta" href="<?php echo get_permalink( $mid ); ?>"><?php echo $plan->get_enroll_text(); ?></a>
						<?php endforeach; ?>
					<?php else : ?>
						<a class="btn gray" href="<?php echo $plan->get_checkout_url(); ?>"><?php echo $plan->get_enroll_text(); ?></a>
					<?php endif; ?>
